...
- Choose N5, N4 or N3 on Home, the map, the collection, or the dojo. N5 has 19 regions and N4 has 36, each with 4–6 kanji grouped within the original themes. Earn all 19 N5 checkpoint seals to open N4's 189 additional kanji and 378 vocabulary examples. You can preview its map and collection before unlocking it. Clearing all 36 N4 seals opens N3: 341 additional kanji in 70 regions, with 1,022 vocabulary examples. All three roads keep separate mastery percentages and completion seals. [N3 coverage, dictionary attribution and regeneration](src/data/n3/SOURCES.md). [Curriculum scope and references](src/data/n4/SOURCES.md) explain the study coverage and foundation bridge cards.
