        ...
        <section className="mt-4 grid gap-3 sm:mt-6 sm:grid-cols-[minmax(0,2fr)_minmax(240px,1fr)] sm:gap-4" aria-label="Daily progress">
          <div className="rounded-2xl border border-border bg-card p-4 shadow-sm sm:p-5">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-full bg-primary/10 px-2.5 py-1 text-[11px] font-bold text-primary">{due > 0 ? `${due} to review` : "Fresh start"}</span>
            </div>
            <p className="mt-2 text-sm text-muted-foreground">
              {due > 0
                ? "Revisit familiar kanji, then meet up to 5 new ones. Every run moves you forward."
                : "You're all caught up. Meet up to 5 fresh kanji in your next run."}
            </p>
          ...
          <div className="flex items-center justify-center gap-4 rounded-2xl border border-border bg-card p-4 shadow-sm sm:p-5">
            <svg className="h-20 w-20 shrink-0 lg:h-[104px] lg:w-[104px]" width="104" height="104" viewBox="0 0 104 104" role="img" aria-label={`N5 mastery ${pct}%`}>
