...
- All level tabs remain selectable for browsing, and the dojo allows free writing on the selected road. Daily lessons remain on N5 until N4 unlocks. A daily run introduces at most five new kanji from one region and includes up to five oldest eligible due reviews from either unlocked road. Each checkpoint covers its complete 4–6-card region once.
